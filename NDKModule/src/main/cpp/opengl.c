...
JNIEXPORT jlong JNICALL
Java_com_mm_zdy_yktproject_GifInfoHandle_renderFrame__JLandroid_graphics_Bitmap_2(JNIEnv *env,
                                                                                  jobject instance,
                                                                                  jlong gifInfoPtr,
                                                                                  jobject bitmap) {
...
Java_com_mm_zdy_yktproject_GifInfoHandle_getWidth__J(JNIEnv *env, jobject instance,
                                                     jlong gifInfoPtr) {
...
JNIEXPORT jint JNICALL
Java_com_mm_zdy_yktproject_GifInfoHandle_getHeight__J(JNIEnv *env, jobject instance,
                                                      jlong gifInfoPtr) {
...
JNIEXPORT jlong JNICALL
Java_com_mm_zdy_yktproject_GifInfoHandle_openStream(JNIEnv *env, jobject instance,
                                                    jobject inputStream) {

    // TODO
    return openStream(env, inputStream);
